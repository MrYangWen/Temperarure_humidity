...
public class InputManualActivity1 extends AppCompatActivity {
...
//            edtManualInput.setSelection(code.length());
        ...
        imgManualcancle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent intent = new Intent( InputManualActivity1.this, MainActivity.class);
                ...
                if (btnManualInput.getText().toString().trim().equals("确定")) {
                    if (edtPhone.getText().length() != 0) {
                        if (edtPhone.getText().toString().trim().matches(Config.phoneFormat)) {
                            ...
                            Toast.makeText( InputManualActivity1.this, "请输入正确的手机格式", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Intent intent = new Intent( InputManualActivity1.this, MainActivity.class);
...
//                code="867967023179486";
                    if (name.equals("")) {
                        Toast.makeText( InputManualActivity1.this, "请输入设备名", Toast.LENGTH_SHORT).show();
                    } else {
                        if (code_edt.equals("")) {
                            Toast.makeText( InputManualActivity1.this, "请输入设备标识码", Toast.LENGTH_SHORT).show();
                        } else {
    ...
    private Handler Datahandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                ...
                Toast.makeText( InputManualActivity1.this, "请输入正确的MAC或SIM卡号或设备esn号", Toast.LENGTH_SHORT).show();
                e.printStackTrace();
                return;
            }
            String name = edtManualInput_name.getText().toString().trim();
...
//                startActivity(intent);
                ...
                Toast.makeText( InputManualActivity1.this, "请检查网络连接", Toast.LENGTH_SHORT).show();
            }
            hintKbTwo();
        }
    };
