...
import static com.mcz.temperarure_humidity_appproject.app.utils.Config.SELFCERTPATH;
import static com.mcz.temperarure_humidity_appproject.app.utils.Config.SELFCERTPWD;
import static com.mcz.temperarure_humidity_appproject.app.utils.Config.TRUSTCAPATH;
import static com.mcz.temperarure_humidity_appproject.app.utils.Config.TRUSTCAPWD;
...
//        params.add(new BasicNameValuePair("accessToken", accessToken));
    ...
    //命令下发
    public static String Comened_DEVICEID(Context mContext, String serverurl, String app_key, String accessToken, String deviceId, String ask)
            throws Exception {
        List<NameValuePair> params = new ArrayList<NameValuePair>();

//        params.add(new BasicNameValuePair("deviceId", deviceId));
//        params.add(new BasicNameValuePair("serviceId", "Humiture"));
//        params.add(new BasicNameValuePair("method", "LED"));
//        params.add(new BasicNameValuePair("Switch", Switch));
        params.add(new BasicNameValuePair("deviceId", deviceId));
        params.add(new BasicNameValuePair("serviceId", "S2m"));
        params.add(new BasicNameValuePair("method", "What"));
        params.add(new BasicNameValuePair("ask", ask));
...
//        params.add(new BasicNameValuePair("deviceType", "MultiSensor"));
//        params.add(new BasicNameValuePair("model", "Humiture"));
...
//        params.add(new BasicNameValuePair("mute", "FALSE"));
        params.add(new BasicNameValuePair("name", name));
        params.add(new BasicNameValuePair("deviceType", "WaterMeter"));
        params.add(new BasicNameValuePair("model", "NBIoTDevice"));
        params.add(new BasicNameValuePair("manufacturerId", "Homay"));
        params.add(new BasicNameValuePair("manufacturerName", "Homay"));
        params.add(new BasicNameValuePair("protocolType", "CoAP"));
